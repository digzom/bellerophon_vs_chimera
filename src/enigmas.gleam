...
O que sou eu?\r",
  ...
  EnigmaRec(
    question: "Gero raiva naqueles que me encontram atrapalhando seu caminho. Quem me\r
destrói muitas vezes foi quem me criou. Não importa o que faça, ou quanto tempo demore.\r
Uma hora ou outra eu vou aparecer novamente.\r
Quem sou eu?\r",
    answer: "Bug",
  ),
  EnigmaRec(
...
Muitos me usam todos os dias, mas poucos sabem do que eu realmente sou capaz.\rQuem sou eu?",
  ...
  EnigmaRec(
    question: "Sou uma linguagem odiada por muitos, amada por muitos outros, e amplamente conhecida até por\r
quem nunca me usou. Por aqueles de constroem a Web, eu sou praticamente inevitável.",
    answer: "Javascript",
  ),
  EnigmaRec(
...
Quando minha replicação foi permitida, uma guerra iniciou-se.",
  ...
  EnigmaRec(
    question: "Meu criador tem a fama de não ser muito gentil com quem quer ajudar à me aprimorar. O que eu sou?",
    answer: "Linux",
  ),
]
